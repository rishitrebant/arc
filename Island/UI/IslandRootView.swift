...
struct IslandRootView: View {
    ...
    /// True while the native AirPlay device list is open.
    @State private var isAirPlayPickerOpen = false
    ...
    var body: some View {
        ...
        //
        // The native device list is outside this view's hit-test region.
        // Keep the island expanded while that list is being used.
        // ---------------------------------------------------------
        .onReceive(
    ...
    private func handleHover(
        ...
        // The native AirPlay device list is outside the island window.
        // Ignore the temporary false hover produced when the pointer
        // moves from the island into that list.
        if isAirPlayPickerOpen && !hovering {
            return
        }
